...
session_start();
if(isset($_GET['id'])){
  $delQry="delete from tbl_booking where booking_id='".$_GET["id"]."'";
...
<html lang="en">
  ...
  <body>
    <h1 align="center" id="heading">Booking Date</h1>
    <table
      id="example"
    ...
    >
      ...
      <tbody>
        <?php                   
            $i = 0;
            $selQry = "SELECT * from tbl_booking b inner join tbl_user u on u.user_id=b.user_id inner join tbl_movieschedule ms on ms.movieschedule_id =b.movieschedule_id  inner join tbl_screen s on s.screen_id=ms.screen_id inner join tbl_movie m on m.movie_id=ms.movie_id where u.user_id='".$_SESSION["uid"]."'";
        ...
        <tr>
          ...
          <td><a href='MyBooking.php?id=<?php echo $data["booking_id"];?>'>Cancel</a> / <a href='Bill.php?id=<?php echo $data["booking_id"];?>'>Bill</a></td>
        </tr>
        <?php
                    }
