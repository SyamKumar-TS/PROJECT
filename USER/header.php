        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="Homepage.php" class="nav-item nav-link">Home</a>
                                <a href="Searchscreen.php" class="nav-item nav-link">Search Shows</a>
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu border-0 m-0">
                        ...
                        <a href="Editprofile.php" class="dropdown-item">Edit</a>
                        <a href="Changepassword.php" class="dropdown-item">Change Password</a>
                    </div>
                </div>
                
                                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Complaint</a>
                    <div class="dropdown-menu border-0 m-0">
                        <a href="Postcomplaint.php" class="dropdown-item">Post Complaint</a>
                        <a href="Complaintreply.php" class="dropdown-item">Complaint Reply's</a>
                    </div>
                </div>
                </div>
