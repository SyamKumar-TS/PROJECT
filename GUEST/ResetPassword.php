...
if(isset($_POST["btnreset"]))
{
	if($_POST["txtnew"]==$_POST["txtconfirm"])
	{
		...
		$sell="select * from tbl_branchmanager where branchmanager_email ='".$_SESSION["lgid"]."'";
		$rowl=$Conn->query($sell);
		...
		{
			$up="update tbl_branchmanager set branchmanager_password ='".$_POST["txtnew"]."' where branchmanager_email ='".$_SESSION["lgid"]."'";
			$Connn->query($up);
		}
		else if($datau=$rowu->fetch_assoc())
		{
			$up="update tbl_user set user_password ='".$_POST["txtnew"]."' where user_email='".$_SESSION["lgid"]."'";
			$Conn->query($up);
		?>
        <script>
