...
<html lang="en" >
    ...
    <body>
        <h1 align="center" id="heading">User Report</h1>
        <br><br>
       <center>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr>
                    <th width="26%" style="text-align:center">Sl.no</th>
                    <th width="29%" style="text-align:center">Name</th>
                    <th width="25%" style="text-align:center">Address</th>
                    <th width="20%" style="text-align:center">Email</th>
                    <th width="20%" style="text-align:center">Gender</th>
...
include("../Assets/Connection/Connection.php");
			 ...
			 $selQry = "select * from tbl_user";
				 ...
				 $rs = $Conn->query($selQry);
                   while ($data = $rs->fetch_assoc()) 
				   {
					   ...
					   $selQry2 = "select * from tbl_user u INNER JOIN tbl_place p ON p.place_id=u.place_id INNER JOIN tbl_district d ON d.district_id=p.district_id where u.user_status='1'";
			...
			?>
              <tr>
                 ...
                 <td align="center"><?php echo $data["user_gender"]; ?></td>
