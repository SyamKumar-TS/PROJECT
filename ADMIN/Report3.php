...
<html lang="en" >
    ...
    <body>
        <h1 align="center" id="heading">Branchmanager Report</h1>
        <br><br>
       <center>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr>
                    <th width="24%" style="text-align:center">Sl.no</th>
                    <th width="22%" style="text-align:center">Name</th>
                    <th width="26%" style="text-align:center">Address</th>
                    <th width="28%" style="text-align:center">Email</th>
...
include("../Assets/Connection/Connection.php");
				...
				$i=0;
			 $selQry = "select * from tbl_branchmanager";
...
$selQry2="select * from tbl_branchmanager u INNER JOIN tbl_place p ON p.place_id=u.place_id INNER JOIN tbl_district d ON d.district_id=p.district_id ";
			...
			?>
              <tr>
                 ...
                 <td align="center"><?php echo $data["branchmanager_name"]; ?></td>
                                  <td align="center"><?php echo $data["branchmanager_address"]; ?></td>
                 <td align="center"><?php echo $data["branchmanager_email"]; ?></td>
