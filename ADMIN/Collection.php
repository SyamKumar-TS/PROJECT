...
<html lang="en" >
    ...
    <body>
        <h1 align="center" id="heading">Collection Report</h1>
        <br><br>
			 ...
			 $selQry = "select * from tbl_movie ";
				 ...
				 $rs = $Conn->query($selQry);
                   while ($data = $rs->fetch_assoc()) 
				   {
					   ...
					   $selQry2 = "select COALESCE(sum(booking_amount),0) as qty from tbl_booking b inner join tbl_movieschedule c on c.movieschedule_id=b.movieschedule_id where movie_id='".$data["movie_id"]."'";
