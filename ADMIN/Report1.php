...
<html lang="en" >
    ...
    <body>
        <h1 align="center" id="heading">Booking Report</h1>
        <br><br>
        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr>
                    ...
                    <th style="text-align:center">Tickets Booked</th>
...
include("../Assets/Connection/Connection.php");
				...
				$i=0;
			 $selQry = "select * from tbl_movie p inner join tbl_category d on p.category_id=d.category_id";
				 ...
				 $rs = $Conn->query($selQry);
                   while ($data = $rs->fetch_assoc()) 
				   {
					   ...
					   $selQry2 = "select COALESCE(count(movie_id),0) as qty from tbl_booking b inner join tbl_movieschedule c on c.movieschedule_id=b.movieschedule_id where movie_id='".$data["movie_id"]."'";
			...
			?>
              <tr>
                 ...
                 <td align="center"><?php echo $data["movie_name"]; ?></td>
