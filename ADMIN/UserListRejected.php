...
<body>
            ...
            <center><h1><u>User rejected list</u></h1></center>
...
<?php
$selQry="select * from tbl_user u INNER JOIN tbl_place p ON p.place_id=u.place_id INNER JOIN tbl_district d ON d.district_id=p.district_id where u.user_status='2'";
